lines = ["...............307............130..................969...601...186.........................................312....628..........878..........",
"......479#../..*..............................#.....*......*............../309.....484........................*......-..........+.....89....",
...
def near(x,y):
    if (any(c in nc for c in lines[x][y]) and 
        (any(c in sc for c in lines[x-1][y]) or 
         any(c in sc for c in lines[x-1][y-1]) or
         any(c in sc for c in lines[x-1][y+1]) or
         any(c in sc for c in lines[x][y+1]) or
         any(c in sc for c in lines[x][y-1]) or
         any(c in sc for c in lines[x+1][y]) or
         any(c in sc for c in lines[x+1][y-1]) or
         any(c in sc for c in lines[x+1][y+1]))
        ):
        print("yes")
